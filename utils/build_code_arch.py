...
def build_resume_state(train_args):
    ...
    if resume_state is None and train_args.local_rank < 1:
...
def build_logger(opt, train_args):
    ...
    # tensorboard logger
    if opt['use_tb_logger'] and 'debug' not in opt['name'] and train_args.local_rank < 1:
